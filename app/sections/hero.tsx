...
import { ArrowRight, MessageCircle, Phone, ArrowUpRight } from "lucide-react"
        ...
        <div>
          ...
          <div className="mt-5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-full border border-[var(--color-accent)]/30 bg-[var(--color-accent-muted)] px-5 py-2.5 text-[0.84rem] font-medium text-[var(--color-accent)] transition-all hover:border-[var(--color-accent)] hover:bg-[var(--color-accent)]/10"
            >
              New: OmFit for Parents is live &rarr;
